...
/*
 * These definitions have been modified by the owner of this repo
 */
#define malloc(SIZE_TO_ALLOC) debugmalloc_malloc_full((SIZE_TO_ALLOC), "malloc", #SIZE_TO_ALLOC, __FILE__, __LINE__, false)
#define calloc(NUMBER_OF_ITEMS,ITEM_SIZE) debugmalloc_malloc_full((NUMBER_OF_ITEMS)*(ITEM_SIZE), "calloc", #NUMBER_OF_ITEMS ", " #ITEM_SIZE, __FILE__, __LINE__, true)
#define realloc(POINTER,SIZE_TO_ALLOC) debugmalloc_realloc_full((POINTER), (SIZE_TO_ALLOC), "realloc", #SIZE_TO_ALLOC, __FILE__, __LINE__)
#define free(POINTER) debugmalloc_free_full((POINTER), "free", __FILE__, __LINE__)
